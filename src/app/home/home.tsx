...
/* Discord — glyph rapi; tanpa width/height atribut */
function DiscordIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" role="img" aria-label="Discord" fill="currentColor" className="block" {...props}>
      <path d="M20.317 4.369a17.5 17.5 0 0 0-4.23-1.31l-.2.37a16.26 16.26 0 0 1 3.53 1.14 13.29 13.29 0 0 0-11.91 0 16.42 16.42 0 0 1 3.54-1.14l-.2-.37a17.55 17.55 0 0 0-4.23 1.31C3.94 7.2 3.18 9.96 3.33 12.68c2.04 1.51 4.01 2.43 5.94 2.94.38-.55.72-1.08 1.01-1.63-1.1-.3-2.18-.73-3.2-1.28.13-.1.26-.21.38-.32 3.06 1.43 6.37 1.43 9.41 0 .13.11.26.22.39.32-1.02.55-2.1.98-3.2 1.28.29.57.64 1.11 1.04 1.63 1.93-.51 3.9-1.43 5.94-2.94.26-4.14-.7-6.88-3.59-8.31ZM9.47 12.37c-.92 0-1.67-.86-1.67-1.92 0-1.06.74-1.93 1.67-1.93.93 0 1.68.87 1.67 1.93 0 1.06-.74 1.92-1.67 1.92Zm5.06 0c-.92 0-1.67-.86-1.67-1.92 0-1.06.74-1.93 1.67-1.93.93 0 1.68.87 1.67 1.93 0 1.06-.74 1.92-1.67 1.92Z" />
    </svg>
  );
}
